...
internal class ImitaterDialog : LawnDialog, SeedPacketsWidgetListener
{
	...
	public ImitaterDialog()
		: base(GlobalStaticVars.gLawnApp, null, 50, isModal: true, "[CHOOSE_SEED_TO_COPY]", "", "[DIALOG_BUTTON_OK]", 3)
	{
		CalcSize(Constants.ImitaterDialog_Size.X, Constants.ImitaterDialog_Size.Y);
		mSeedPacketsWidget = new SeedPacketsWidget(mApp, 10, theIsImitaters: true, this);
