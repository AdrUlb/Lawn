...
internal class CutScene
{
	...
	public void CancelIntro()
	{
		...
		if (mCutsceneTime < TimePanRightEnd + mCrazyDaveTime)
		{
			...
			{
				AdvanceCrazyDaveDialog(theJustSkipping: true);
			}
			if (mBoard.mLevel == 5)
			{
	...
	public void AnimateBoard()
	{
		...
		if (mSodTime > 0)
		{
			...
			if (mCutsceneTime == num16)
			{
				...
				if (mBoard.mLevel == 1)
				{
					mApp.AddReanimation(Constants.BOARD_EDGE, 0f, 400000, ReanimationType.REANIM_SODROLL, theDoScalePos: false);
				...
				{
					mApp.AddReanimation((float)Constants.BOARD_EDGE - 10f, (float)Constants.CutScene_SodRoll_1_Pos * Constants.S, 400000, ReanimationType.REANIM_SODROLL, theDoScalePos: false);
					mApp.AddReanimation((float)Constants.BOARD_EDGE - 10f, (float)Constants.CutScene_SodRoll_2_Pos * Constants.S, 400000, ReanimationType.REANIM_SODROLL, theDoScalePos: false);
				...
				{
					mApp.AddReanimation((float)(Constants.CutScene_SodRoll_3_Pos.X + Constants.BOARD_EDGE) + 10f, (float)Constants.CutScene_SodRoll_3_Pos.Y * Constants.S, 400000, ReanimationType.REANIM_SODROLL, theDoScalePos: false);
					mApp.AddReanimation((float)(Constants.CutScene_SodRoll_4_Pos.X + Constants.BOARD_EDGE) + 10f, (float)Constants.CutScene_SodRoll_4_Pos.Y * Constants.S, 400000, ReanimationType.REANIM_SODROLL, theDoScalePos: false);
	...
	public void UpdateZombiesWon()
	{
		...
		if (mCutsceneTime == LostTimeEnd)
		{
			...
			{
				GameOverDialog theDialog2 = new GameOverDialog("", theShowChallengeName: false);
	...
	public void MouseDown(int x, int y)
	{
		...
		{
			AdvanceCrazyDaveDialog(theJustSkipping: false);
		}
	...
	public void AdvanceCrazyDaveDialog(bool theJustSkipping)
	{
		...
		if ((mApp.mCrazyDaveMessageIndex == 1503 || mApp.mCrazyDaveMessageIndex == 1553) && !theJustSkipping)
		{
			...
			LawnDialog lawnDialog = mApp.DoDialog(51, isModal: true, moneyString, theDialogLines, string.Empty, 1);
	...
	public void PreloadResources()
	{
		...
		if (mCrazyDaveDialogStart != -1)
		{
			ReanimatorXnaHelpers.ReanimatorEnsureDefinitionLoaded(ReanimationType.REANIM_CRAZY_DAVE, theIsPreloading: true);
		}
		if (mApp.mPlayerInfo.mPurchases[24] != 0)
		{
			ReanimatorXnaHelpers.ReanimatorEnsureDefinitionLoaded(ReanimationType.REANIM_RAKE, theIsPreloading: true);
		}
		...
		if (mBoard.StageHasRoof())
		{
			ReanimatorXnaHelpers.ReanimatorEnsureDefinitionLoaded(ReanimationType.REANIM_ROOF_CLEANER, theIsPreloading: true);
		}
		else
		{
			ReanimatorXnaHelpers.ReanimatorEnsureDefinitionLoaded(ReanimationType.REANIM_LAWNMOWER, theIsPreloading: true);
		}
		if (mBoard.StageHasPool())
		{
			ReanimatorXnaHelpers.ReanimatorEnsureDefinitionLoaded(ReanimationType.REANIM_SPLASH, theIsPreloading: true);
			ReanimatorXnaHelpers.ReanimatorEnsureDefinitionLoaded(ReanimationType.REANIM_POOL_CLEANER, theIsPreloading: true);
		}
		if (mBoard.CanDropLoot())
		{
			ReanimatorXnaHelpers.ReanimatorEnsureDefinitionLoaded(ReanimationType.REANIM_COIN_SILVER, theIsPreloading: true);
			ReanimatorXnaHelpers.ReanimatorEnsureDefinitionLoaded(ReanimationType.REANIM_COIN_GOLD, theIsPreloading: true);
			ReanimatorXnaHelpers.ReanimatorEnsureDefinitionLoaded(ReanimationType.REANIM_DIAMOND, theIsPreloading: true);
		}
		if (mSodTime > 0)
		{
			ReanimatorXnaHelpers.ReanimatorEnsureDefinitionLoaded(ReanimationType.REANIM_SODROLL, theIsPreloading: true);
		}
		if (mApp.mGameMode == GameMode.GAMEMODE_CHALLENGE_PORTAL_COMBAT)
		{
			ReanimatorXnaHelpers.ReanimatorEnsureDefinitionLoaded(ReanimationType.REANIM_PORTAL_CIRCLE, theIsPreloading: true);
			ReanimatorXnaHelpers.ReanimatorEnsureDefinitionLoaded(ReanimationType.REANIM_PORTAL_SQUARE, theIsPreloading: true);
		}
		...
		{
			ReanimatorXnaHelpers.ReanimatorEnsureDefinitionLoaded(ReanimationType.REANIM_RAIN_CIRCLE, theIsPreloading: true);
			ReanimatorXnaHelpers.ReanimatorEnsureDefinitionLoaded(ReanimationType.REANIM_RAIN_SPLASH, theIsPreloading: true);
		}
		if (mApp.mGameMode == GameMode.GAMEMODE_INTRO)
		{
