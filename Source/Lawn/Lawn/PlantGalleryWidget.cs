	...
	public override void Draw(Graphics g)
	{
		...
		for (int i = 0; i < 2; i++)
		{
			for (int j = 0; j < GameConstants.NUM_ALMANAC_SEEDS; j++)
			{
				...
				{
					SeedPacket.DrawSmallSeedPacket(g, x, y, seedType, SeedType.SEED_NONE, 0f, 255, seedType != SeedType.SEED_IMITATER && flag, theUseCurrentCost: false, flag2, seedType != SeedType.SEED_IMITATER && flag2);
				}
			}
			flag = true;
			flag2 = false;
