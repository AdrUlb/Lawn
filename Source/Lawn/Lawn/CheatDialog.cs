...
internal class CheatDialog : LawnDialog, EditListener
{
	...
	public CheatDialog(LawnApp theApp)
		: base(theApp, null, 35, isModal: true, "CHEAT", "Enter New Level:", "", 2)
	{
		mApp = theApp;
	...
	public bool ApplyCheat()
	{
		...
		if (result <= 0)
		{
			mApp.DoDialog(36, isModal: true, "Enter Level", "Invalid Level. Do 'number' or 'area-subarea' or 'Cnumber' or 'Farea-subarea'.", "OK", 3);
			return false;
		}
