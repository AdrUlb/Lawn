...
internal class Trail
{
	...
	public void Draw(Graphics g)
	{
		...
		for (int i = 0; i < mNumTrailPoints - 1; i++)
		{
			...
			SexyColor sexyColor = mColorOverride;
			SexyColor sexyColor2 = mColorOverride;
			sexyColor.mAlpha = mAlpha;
			sexyColor2.mAlpha = mAlpha2;
