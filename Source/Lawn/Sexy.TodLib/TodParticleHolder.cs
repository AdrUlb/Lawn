...
internal class TodParticleHolder
{
	...
	public TodParticleSystem AllocParticleSystemFromDef(float theX, float theY, int theRenderOrder, TodParticleDefinition theDefinition, ParticleEffect theParticleEffect)
	{
		...
		{
			Debug.OutputDebug("Too many particle systems\n");
			return null;
		}
		if (mEmitters.Count + theDefinition.mEmitterDefCount > mEmitters.Capacity)
		{
			Debug.OutputDebug("Too many particle emitters\n");
			return null;
		}
	...
	{
		if (mParticleSystems.Count > 100 || mEmitters.Count > 100 || mParticles.Count > 100)
		{
			return true;
		}
		return false;
