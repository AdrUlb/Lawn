...
internal class SexyParticleReader : ContentTypeReader<TodParticleDefinition>
{
	protected override TodParticleDefinition Read(ContentReader input, TodParticleDefinition existingInstance)
	{
		...
		todParticleDefinition.mEmitterDefCount = ((BinaryReader)(object)input).ReadInt32();
		...
		for (int j = 0; j < todParticleDefinition.mEmitterDefCount; j++)
		{
			...
			string theStringId = ((BinaryReader)(object)input).ReadString();
			todEmitterDefinition.mImage = AtlasResources.GetImageInAtlasById(AtlasResources.GetAtlasIdByStringId(theStringId));
			todEmitterDefinition.mImageCol = ((BinaryReader)(object)input).ReadInt32();
			todEmitterDefinition.mImageRow = ((BinaryReader)(object)input).ReadInt32();
			todEmitterDefinition.mImageFrames = ((BinaryReader)(object)input).ReadInt32();
			todEmitterDefinition.mAnimated = ((BinaryReader)(object)input).ReadInt32();
			todEmitterDefinition.mParticleFlags = ((BinaryReader)(object)input).ReadInt32();
			todEmitterDefinition.mEmitterType = (EmitterType)((BinaryReader)(object)input).ReadInt32();
			todEmitterDefinition.mName = ((BinaryReader)(object)input).ReadString();
			todEmitterDefinition.mOnDuration = ((BinaryReader)(object)input).ReadString();
			...
			todEmitterDefinition.mParticleFieldCount = ((BinaryReader)(object)input).ReadInt32();
			...
			for (int l = 0; l < todEmitterDefinition.mParticleFieldCount; l++)
			{
				...
				todEmitterDefinition.mParticleFields[l].mFieldType = (ParticleFieldType)((BinaryReader)(object)input).ReadInt32();
			}
			todEmitterDefinition.mSystemFieldCount = ((BinaryReader)(object)input).ReadInt32();
			...
			for (int n = 0; n < todEmitterDefinition.mSystemFieldCount; n++)
			{
				...
				todEmitterDefinition.mSystemFields[n].mFieldType = (ParticleFieldType)((BinaryReader)(object)input).ReadInt32();
			}
	...
	{
		track.mCountNodes = ((BinaryReader)(object)input).ReadInt32();
		...
		for (int j = 0; j < track.mCountNodes; j++)
		{
			...
			floatParameterTrackNode.mTime = ((BinaryReader)(object)input).ReadSingle();
			floatParameterTrackNode.mLowValue = ((BinaryReader)(object)input).ReadSingle();
			floatParameterTrackNode.mHighValue = ((BinaryReader)(object)input).ReadSingle();
