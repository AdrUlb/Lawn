...
internal class ScrollbuttonWidget : ButtonWidget
{
	...
	public ScrollbuttonWidget(int theId, ButtonListener theButtonListener)
		: this(theId, theButtonListener, 0)
	{
	}

	public ScrollbuttonWidget(int theId, ButtonListener theButtonListener, int theType)
	...
	public override void Draw(Graphics g)
	{
		...
		else if (mDisabled && mDisabledImage != null)
		{
