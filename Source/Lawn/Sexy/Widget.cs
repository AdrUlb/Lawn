...
internal class Widget : WidgetContainer
{
	...
	{
		return WriteString(g, theString, theX, theY, theWidth, theJustification, drawString: true, 0, -1);
	}

	public virtual int WriteString(Graphics g, string theString, int theX, int theY, int theWidth)
	{
		return WriteString(g, theString, theX, theY, theWidth, -1, drawString: true, 0, -1);
	}

	public virtual int WriteString(Graphics g, string theString, int theX, int theY)
	{
		return WriteString(g, theString, theX, theY, -1, -1, drawString: true, 0, -1);
	}
