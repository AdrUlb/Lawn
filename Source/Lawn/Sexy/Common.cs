...
internal static class Common
{
	...
	{
		if (!StringToUpperCache.TryGetValue(theString, out var value))
		{
	...
	{
		if (!StringToLowerCache.TryGetValue(theString, out var value))
		{
	...
	{
		return GetFileName(thePath, noExtension: false);
	}
	...
	{
		return GetFileDir(thePath, withSlash: false);
	}
	...
	public static bool Deltree(string thePath)
	{
		...
		{
			Directory.Delete(thePath, recursive: true);
			return true;
		}
		return false;
	}
